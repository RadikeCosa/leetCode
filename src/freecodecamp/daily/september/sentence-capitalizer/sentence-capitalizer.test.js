import capitalize from "./sentence-capitalizer";
...
describe("Sentence Capitalizer", () => {
  it("test case 1", () => {
    ...
    const expected = "This is a simple sentence.";
  ...
  it("test case 3", () => {
    const input = "i did today's coding challenge... it was fun!!";
    const expected = "I did today's coding challenge... It was fun!!";
    expect(capitalize(input)).toBe(expected);
  });

  it("test case 4", () => {
    const input = "crazy!!!strange???unconventional...sentences.";
    const expected = "Crazy!!!Strange???Unconventional...Sentences.";
    expect(capitalize(input)).toBe(expected);
  });
