...
describe("Apply Transform Over Each Element in Array", () => {
  ...
  it("should apply function that uses index", () => {
    const arr = [1, 2, 3];
    const fn = function plusI(n: number, i: number): number {
      return n + i;
    };
    const result = map(arr, fn);
  ...
  it("should apply constant function", () => {
    const arr = [10, 20, 30];
    const fn = function constant(): number {
      return 42;
    };
    const result = map(arr, fn);
  ...
  it("should handle single element array", () => {
    const arr = [5];
    const fn = function double(n: number): number {
      return n * 2;
    };
    const result = map(arr, fn);
  ...
  it("should handle negative numbers", () => {
    const arr = [-1, -2, -3];
    const fn = function abs(n: number): number {
      return Math.abs(n);
    };
    const result = map(arr, fn);
