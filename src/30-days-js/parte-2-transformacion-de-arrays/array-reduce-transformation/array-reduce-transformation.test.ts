...
describe("Array Reduce Transformation", () => {
  ...
  it("should sum squares starting from 100", () => {
    const nums = [1, 2, 3, 4];
    const fn = function sumSquares(accum: number, curr: number): number {
  ...
  it("should handle multiplication operation", () => {
    const nums = [1, 2, 3, 4];
    const fn = function multiply(accum: number, curr: number): number {
      return accum * curr;
    };
    const init = 1;
    const result = reduce(nums, fn, init);
  ...
  it("should handle subtraction operation", () => {
    const nums = [1, 2, 3];
    const fn = function subtract(accum: number, curr: number): number {
      return accum - curr;
    };
    const init = 10;
    const result = reduce(nums, fn, init);
  ...
  it("should handle single element array", () => {
    const nums = [5];
    const fn = function add(accum: number, curr: number): number {
      return accum + curr;
    };
    const init = 3;
    const result = reduce(nums, fn, init);
  ...
  it("should handle max operation", () => {
    ...
    const fn = function max(accum: number, curr: number): number {
  ...
  it("should handle min operation", () => {
    ...
    const fn = function min(accum: number, curr: number): number {
  ...
  it("should handle complex operation", () => {
    const nums = [1, 2, 3];
    const fn = function complex(accum: number, curr: number): number {
