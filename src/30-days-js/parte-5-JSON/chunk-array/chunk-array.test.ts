...
describe("Chunk Array", () => {
  ...
  it("Should chunk array into subarrays of size 1", () => {
    expect(chunk([1, 2, 3, 4, 5] as any, 1)).toEqual([[1], [2], [3], [4], [5]]);
  });

  it("Should chunk array into subarrays of size 3", () => {
    expect(chunk([1, 9, 6, 3, 2] as any, 3)).toEqual([
      [1, 9, 6],
      [3, 2],
    ]);
  });
